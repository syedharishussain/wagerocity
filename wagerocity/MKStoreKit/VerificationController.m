...
- (BOOL)verifyPurchase:(SKPaymentTransaction *)transaction
{
    ...
    NSString *jsonObjectString = [self encodeBase64:(uint8_t *)[NSData dataWithContentsOfURL:[[NSBundle mainBundle] appStoreReceiptURL]].bytes
                                             length:[NSData dataWithContentsOfURL:[[NSBundle mainBundle] appStoreReceiptURL]].length];
...
{
    if (!(transaction && [[NSBundle mainBundle] appStoreReceiptURL] && [[NSBundle mainBundle] appStoreReceiptURL] > 0))
    {
    ...
    NSDictionary *receiptDict       = [self dictionaryFromPlistData:[NSData dataWithContentsOfURL:[[NSBundle mainBundle] appStoreReceiptURL]]];
